...
def extract_dll(dll_path, output_dir):
    ...
    try:
        ...
        subprocess.check_call(["7z", "x", dll_path, f"-o{output_dir}", "-y"], stdout=subprocess.DEVNULL)
        return True
...
def convert_audio(resources_dir):
    print("Converting audio files to 44100Hz...")
    ...
    for fpath in wma_files:
        ...
        try:
            ...
            subprocess.check_call([
                "ffmpeg", "-i", fpath, "-ar", "44100", tmp_path, "-y", "-v", "error"
            ])
